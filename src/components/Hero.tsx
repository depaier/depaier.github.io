          ...
          <ContentContainer>
            ...
            <SnsSection>
              ...
              <SnsIcons>
                <SnsIcon
                  onClick={() =>
                    window.open("https://www.instagram.com/depaier/", "_blank")
                  }
                >
                  <svg
                ...
                <SnsIcon
                  onClick={() =>
                    window.open("https://www.threads.net/@depaier", "_blank")
                  }
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <AppsSection>
              ...
              <AppsGrid>
                ...
                >
                  <AppIcon>
                    <img
                      src="melater_logo.png"
                      alt="logo"
                      height="20"
                      width="20"
                    />
                  </AppIcon>
                  <AppName>Melater</AppName>
                </AppCard>
              </AppsGrid>
            </AppsSection>
